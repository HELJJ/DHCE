...
def tree_building(train_seqs, valid_seqs, test_seqs, types_file, graph_file, out_file):
    ...
    pickle.dump(train_new_seqs, open(os.path.join('../data/mimic3/standard/train', 'inputs.seqs'), 'wb'), -1)
    pickle.dump(valid_new_seqs, open(os.path.join('../data/mimic3/standard/valid', 'inputs.seqs'), 'wb'), -1)
    pickle.dump(test_new_seqs, open(os.path.join('../data/mimic3/standard/test', 'inputs.seqs'), 'wb'), -1)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output",
                        type=str,
                        #required=True,
                        default='/home/ubuntu/Zhang/integrate/data/mimic3',
                        help="The output directory where the processed files will be written.")
    parser.add_argument("--train_seqs",
                        type=str,
                        #required=True,
                        default='/home/ubuntu/Zhang/integrate/data/mimic3/standard/train/know_code.npy',
                        help="The path of train seqs file.")
    parser.add_argument("--valid_seqs",
                        type=str,
                        # required=True,
                        default='/home/ubuntu/Zhang/integrate/data/mimic3/standard/valid/know_code.npy',
                        help="The path of valid seqs file.")
    parser.add_argument("--test_seqs",
                        type=str,
                        # required=True,
                        default='/home/ubuntu/Zhang/integrate/data/mimic3/standard/test/know_code.npy',
                        help="The path of test seqs file.")
    parser.add_argument("--vocab",
                        type=str,
                        #required=True,
                        default='/home/ubuntu/Zhang/integrate/data/mimic3/parsed/vocab.txt',
