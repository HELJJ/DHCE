...
def evaluate_codes(model, dataset, loss_fn, output_size, historical=None):
    ...
    for step in range(len(dataset)):
        code_x, visit_lens, divided, y, neighbors, events, know_code_inputs, know_code_mask,  diagnosis_list = dataset[step]
        output = model(code_x, divided, neighbors, visit_lens, events, know_code_inputs, know_code_mask, diagnosis_list)
